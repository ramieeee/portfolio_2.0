...
export default function TimelineCard({
  ...
  return (
    <div className="flex flex-row w-full">
      {/* number part */}
      <div className="flex items-start w-1/5 text-right">
        <div className="text-size-subtitle font-suitBold text-color-main">{`${careerData.time.from.year}.${startMonth} - ${careerData.time.until.year}.${endMonth}`}</div>
      </div>
      ...
      <div className="flex flex-col w-3/5 gap-4">
        ...
        <div className="flex flex-row gap-4 text-size-body font-suit text-color-main">
